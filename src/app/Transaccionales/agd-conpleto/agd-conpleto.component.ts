...
@Component({
    ...
    templateUrl: './agd-conpleto.component.html',
    styleUrl: './agd-conpleto.component.scss'
})
export class AgdConpletoComponent implements OnInit {
    ...
    GraficoCO2() {
        ...
        this.basicDataCO2 = {
            labels: ['12', '24', '36', '48', '72', '84', '96', '108', '120'],
            datasets: [
                {
                    label: 'CO2',
                    backgroundColor: documentStyle.getPropertyValue('--red-500'),
                    borderColor: documentStyle.getPropertyValue('--red-500'),
                    data: [90, 30, 20, 15, 10, 8, 7, 10, 7, 6]
                }
            ]
        };
        console.log(this.basicDataCO2.datasets);
    ...
    GraficoCO() {
        ...
        const surfaceBorder = documentStyle.getPropertyValue('--surface-border');
        this.basicDataCO = {
            labels: ['33,96', '67,92', '101,88', '135,84', '169,8', '203,76', '237,72', '271,68', '305,64', '339,6'],
            datasets: [
                {
                    label: 'CO',
    ...
    GraficoH2() {
        ...
        const surfaceBorder = documentStyle.getPropertyValue('--surface-border');
        this.basicDataH2 = {
            labels: ['4.44', '8.88', '13.32', '17.76', '22.2', '26.64', '31.08', '35.52', '39.96', '44.4'],
            datasets: [
                {
                    label: 'H2',
    ...
    GraficoCH4() {
        ...
        const surfaceBorder = documentStyle.getPropertyValue('--surface-border');
        this.basicDataCH4 = {
            labels: ['17.64', '35.28', '52.92', '70.56', '88.2', '105.84', '123.48', '141.12', '158.76', '176.4'],
            datasets: [
                {
                    label: 'CH4',
    ...
    GraficoC2H6() {
        ...
        const surfaceBorder = documentStyle.getPropertyValue('--surface-border');
        this.basicDataC2H6 = {
            labels: ['12.96', '25.92', '38.88', '51.84', '64.8', '77.76', '90.72', '103.68', '116.64', '129.6'],
            datasets: [
                {
                    label: 'C2H6',
    ...
    GraficoC2H4() {
        ...
        const surfaceBorder = documentStyle.getPropertyValue('--surface-border');
        this.basicDataC2H4 = {
            labels: ['3.48', '6.96', '10.44', '13.92', '17.4', '20.88', '24.36', '27.84', '31.32', '34.8'],
            datasets: [
                {
                    label: 'C2H4',
    ...
    GraficoC2H2() {
        ...
        const surfaceBorder = documentStyle.getPropertyValue('--surface-border');
        this.basicDataC2H2 = {
            labels: ['0.01', '0.02', '0.04', '0.05', '0.06', '0.07', '0.08', '0.1', '0.11', '0.12'],
            datasets: [
                {
                    label: 'C2H2',
    ...
    GraficoTGC() {
        ...
        const surfaceBorder = documentStyle.getPropertyValue('--surface-border');
        this.basicDataTGC = {
            labels: ['157.33', '314.16', '471.0', '627.83', '784.66', '941.5', '1098.33', '1255.16', '1412.0', '1568.83'],
            datasets: [
                {
                    label: 'TGC',
